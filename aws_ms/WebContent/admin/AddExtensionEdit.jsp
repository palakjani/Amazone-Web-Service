...
<jsp:include page="leftpanel.jsp"></jsp:include>
                ...
                <form  method="post" id="basicForm" action="<%=request.getContextPath() %>/ExtensionController" class="form-horizontal">
                 <c:forEach items="${sessionScope.extensionList}" var="j">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-8">
                      <input type="text" name="extensionName" value="${j.extensionName}" class="form-control" placeholder="Enter your extension name..." required />
                    </div> 
                  </div>
  ...
  <div class="form-group">
                    ...
                    <div class="col-sm-8">
                      <textarea rows="5" name="extensionDescription" class="form-control" placeholder="Type your Description..." required>${j.extensionDescription}</textarea>
                    </div>
                  </div>
                  ...
                  <div class="row">
                    <div class="col-sm-9 col-sm-offset-3">
                      <input type ="submit" value="Update"  class="btn btn-success btn-quirk btn-wide mr5">
                       <input type="hidden" name="flag" value="UpdateExtension">
                        <input type="hidden" name="extensionId" value="${j.extensionId}">
