                ...
                <form method="post" id="basicForm" action="<%=request.getContextPath()%>/categoryController" class="form-horizontal">
                 <c:forEach items="${sessionScope.categoryList}" var="j">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-8">
                      <input type="text" value="${j.categoryName}" name="categoryName" class="form-control" placeholder="Enter your Category..." required />
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-8">
                      <textarea rows="5" class="form-control" name="categoryDescription" placeholder="Type your Description..." required>${j.categoryDescription}</textarea>
                    </div><br>
