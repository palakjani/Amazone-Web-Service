...
<body>
  ...
  <header>
    <div class="headerpanel">
      ...
      <div class="logopanel">
        <h2><a href="index.jsp">Quirk</a></h2>
      </div><!-- logopanel -->
        ...
        <div class="panel-body">
          <div class="table-responsive">
			...
			<tr>
				...
				<td>
				<div class="btn-group mb-sm"><button class="btn btn-inverse dropdown-toggle" data-toggle="dropdown" type="button" name="${i.id}">Action<span class="caret"></span></button>
				<ul class="dropdown-menu" role="menu">
				<li><a href="<%=request.getContextPath()%>/categoryController?flag=EditCategory&categoryId=${i.id}">EDIT</a></li>
				<li><a href="<%=request.getContextPath()%>/categoryController?flag=DeleteCategory&categoryId=${i.id}">DELETE</a></li>
				</ul>
				</div>
				</td>
			</tr>
