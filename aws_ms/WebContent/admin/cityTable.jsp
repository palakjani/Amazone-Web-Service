        ...
        <div class="panel-body">
          <div class="table-responsive">
			...
			<tr>
				...
				<td>
				<div class="btn-group mb-sm"><button class="btn btn-inverse dropdown-toggle" data-toggle="dropdown" type="button" name="${i.cid}">Action<span class="caret"></span></button>
				<ul class="dropdown-menu" role="menu">
				<li><a href="<%=request.getContextPath()%>/CityController?flag=EditCity&cityId=${i.cid}">EDIT</a></li>
				<li><a href="<%=request.getContextPath()%>/CityController?flag=DeleteCity&cityId=${i.cid}">DELETE</a></li>
				</ul>
				</div>
				</td>
