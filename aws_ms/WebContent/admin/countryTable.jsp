        ...
        <div class="panel-body">
          <div class="table-responsive">
			...
			<tr>
				...
				<a href="<%=request.getContextPath()%>/countryController?flag=Editcountry&countryid=${i.id}">EDIT</a></li>
				<li><a href="<%=request.getContextPath()%>/countryController?flag=Deletecountry&countryid=${i.id}">DELETE</a></li>
				</ul></div></td>
			</tr>
