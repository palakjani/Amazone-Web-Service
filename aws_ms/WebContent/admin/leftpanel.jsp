          ...
          <ul class="nav nav-pills nav-stacked nav-quirk">
           ...
           <li class="nav-parent"><a href=""><i class="fa fa-suitcase"></i> <span>Manage Category</span></a>
              <ul class="children">
                ...
                <li><a href="<%=request.getContextPath()%>/categoryController?flag=SearchCategory">Search Category</a></li>
                <li><a href="<%=request.getContextPath()%>/ExtensionController?flag=searchCategory">Add Category Extension</a></li>
            ...
            <li class="nav-parent"><a href=""><i class="fa fa-suitcase"></i> <span>Manage Storage</span></a>
              <ul class="children">
                ...
                <li><a href="<%=request.getContextPath()%>/StoragePlanController?flag=SearchStorage">View Storage</a></li>
              
              </ul>
                <li class="nav-parent"><a href=""><i class="fa fa-suitcase"></i> <span>Manage Country</span></a>
              <ul class="children">
                <li><a href="country.jsp">Add Country</a></li>
                <li><a href="<%=request.getContextPath()%>/countryController?flag=SearchCountry">View Country</a></li>
            ...
            <li class="nav-parent"><a href="index.jsp"><i class="fa fa-suitcase"></i> <span>Manage Archivework</span></a></li>
          
          
            <li class="nav-parent"><a href="index.jsp"><i class="fa fa-suitcase"></i> <span>Manage Security</span></a></li>
            
            <li class="nav-parent"><a href="index.jsp"><i class="fa fa-file-text"></i> <span>Contain Distribution</span></a></li>
            
           
            <li class="nav-parent"><a href="index.jsp"><i class="fa fa-file-text"></i> <span>Access Control List</span></a></li>
            
            <li class="nav-parent"><a href="index.jsp"><i class="fa fa-suitcase"></i> <span>Manage Semantics</span></a></li>
            <li class="nav-parent"><a href="index.jsp"><i class="fa fa-file-text"></i> <span>Report Generation </span></a></li>
