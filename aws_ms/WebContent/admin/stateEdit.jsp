...
<jsp:include page="leftpanel.jsp"></jsp:include>
  ...
  <div class="mainpanel">
    ...
    <div class="form-group">
                    ...
                    <div class="col-sm-8">
										<select name="country" class="select2 select2-hidden-accessible"
                  ...
                  <div class="form-group">
                   ...
                   <div class="col-sm-8">
                      <input type="text" value="${j.stateName}"  name="stateName" class="form-control" placeholder="Enter your State Name..." required />
                    </div> 
                  </div>
 				 <div class="form-group">
                    <label class="col-sm-3 control-label">Description <span class="text-danger">*</span></label>
                    <div class="col-sm-8">
                      <textarea name="stateDescription" rows="5" class="form-control" placeholder="Type your Description..." required>${j.stateDescription}</textarea>
                    </div>
                  </div>
                  <hr>
                  <div class="row">
