...
<jsp:include page="leftpanel.jsp"></jsp:include>
  ...
  <div class="mainpanel">
    ...
    <div class="form-group">
                    ...
                    <div class="col-sm-8">
										<select name="State" class="select2 select2-hidden-accessible"
                  ...
                  <div class="form-group">
                   ...
                   <div class="col-sm-8">
                      <input type="text" value="${j.cityName}"  name="cityName" class="form-control" placeholder="Enter your city Name..." required />
                    </div> 
                  </div>
 				 <div class="form-group">
                    <label class="col-sm-3 control-label">Description <span class="text-danger">*</span></label>
                    <div class="col-sm-8">
                      <textarea name="cityDescription" rows="5" class="form-control" placeholder="Type your Description..." required>${j.stateDescription}</textarea>
                    </div>
                  </div>
                  <hr>
                  <div class="row">
                    <div class="col-sm-9 col-sm-offset-3">
                      ...
                      <input type="hidden" name="cid" value="${j.cid }">
