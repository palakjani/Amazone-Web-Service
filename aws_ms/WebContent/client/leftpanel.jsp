    ...
    <div class="leftpanelinner">
      ...
      <div class="media leftpanel-profile">
        ...
        <div class="media-body">
          <h4 class="media-heading">Palak jani<a data-toggle="collapse" data-target="#loguserinfo" class="pull-right"><i class="fa fa-angle-down"></i></a></h4>
          ...
          <ul class="nav nav-pills nav-stacked nav-quirk">
            ...
            <li class="nav-parent"><a href=""><i class="fa fa-file-text"></i> <span> Storage</span></a>
              <ul class="children">
                ...
                <li><a href="UploadFile.jsp">UploadFile</a></li>
            ...
            <li class="nav-parent"><a href="index.jsp"><i class="fa fa-file-text"></i> <span>Version</span></a></li>
          
            <li class="nav-parent"><a href="index.jsp"><i class="fa fa-file-text"></i> <span>Archivework</span></a></li>
          
          
            <li class="nav-parent"><a href="index.jsp"><i class="fa fa-file-text"></i> <span>Security</span></a></li>
